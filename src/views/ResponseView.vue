...
export default {
  ...
  computed : {
    bcItems() {
     return [{text: 'Home', to: {name: 'home'}},{text: 'Responses', to: {name: 'objectsview', params: {dimension: 'response'}}},{text: this.objt.theName, to : {name: 'response'}}]
    }
  },
  components : {
    Response 
  ...
  methods : {
    commitResponse(objt) {
      ...
      this.commitObject(updateUrl,createUrl,'objectsview',undefined,'response');
    }
  }
}
</script>