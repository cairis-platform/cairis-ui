...
-->
  ...
  <b-modal ref="riskDialog" ok-only :title="dialogTitle">
    <b-container v-if="objt != undefined">
      <b-form-group label="<b>Threat</b>" label-class="text-sm-left" label-cols="3" label-for="theThreat" >
        <b-form-input readonly id="theThreat" v-model="objt.theThreatName"></b-form-input>
      </b-form-group>
      <b-form-group label="<b>Vulnerability</b>" label-class="text-sm-left" label-cols="3" label-for="theVulnerability" >
        <b-form-input readonly id="theVulnerability" v-model="objt.theVulnerabilityName"></b-form-input>
      </b-form-group>
      <b-form-group label="<b>Risk Rating</b>" label-class="text-sm-left" label-cols="3" label-for="theRiskRating" >
