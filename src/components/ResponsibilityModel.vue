...
-->
  ...
  <div class="responsibilitymodel">
    ...
    <b-container fluid>
      <b-row>
        <b-col>
          <b-form-group label="Environment" label-for="responsibilityModelEnvironment" :label-cols="4" horizontal>
        ...
        <b-col v-if="theEnvironmentName != ''">
          <b-form-group label="Role" label-for="responsibilityModelRole" :label-cols="2" horizontal>
